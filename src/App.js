...
const GameList = () => {
  ...
  */
  ...
  useEffect(() => {
    ...
    if (selectedGenre !== "") {
      newGames = newGames.filter((b) => b.genres.includes(selectedGenre));
    }
  ...
  return (
    <div className="container py-5">
      ...
      */}
      <div className="row">
        {game.map((games) => (
          <div className="col-lg-4 col-md-6 col-sm-12 my-3" key={games.title}>
            <div className="card">
              <img
              ...
              <div className="card-body">
                <h2 className="card-title">{games.title}</h2>
                <span>
                  Genres:
                  {games.genres.length > 0 && ` ${games.genres.join(", ")}`}
                </span>
